...
create_outdir_lipo()
{
	for lib_i386 in `find $LOCAL_OUTDIR/i386 -name "lib*.a"`; do
		...
		xcrun -sdk iphoneos lipo -arch arm64 $lib_arm64 -arch armv7s $lib_arm7s -arch i386 $lib_i386 -create -output $lib
	done
}
...
rm -rf $LOCAL_OUTDIR
mkdir -p $LOCAL_OUTDIR/i386 $LOCAL_OUTDIR/arm7s $LOCAL_OUTDIR/arm64
